...
public class OrderModel {
	//To generate right click mouse -> Source -> generate
	//properties of OrderModel
	long id = 0L;
	String orderNo = "";
	String productName = "";
	float price = 0;
	int quantity = 0;
	//Constructor of OrderModel 
